...
| **Solo Leveling** *(só estilo visual)* | Janelas de "sistema" translúcidas com texto claro e notificações animadas | Visual do Grimório | [A "System" em detalhe (CBR)](https://www.cbr.com/solo-leveling-anime-system-create/) · [Recriação web](https://github.com/digishivam/sololevelingsystemui) |
...
| **CSS CRT** | Linhas de varredura, brilho e cintilação de terminal | Técnica para o Grimório | [Exemplo 1](https://codepen.io/dentednerd/pen/vYbgLMp) · [Exemplo 2](https://codepen.io/travis-g/pen/XNLBaa) |
